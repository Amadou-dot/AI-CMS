...
interface CaseStudiesDocumentData {
  ...
  /**
   * Logo field in *Case Studies*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.logo
   * - **Tab**: Main
...
export interface BentoSliceDefaultPrimaryBentoItem {
  ...
  /**
   * Description field in *Bento → Default → Primary → bento*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
...
/**
 * Primary content in *Hero → Hero Preview → Primary*
 */
export interface HeroSliceDefaultPrimary {
  /**
   * Heading field in *Hero → Hero Preview → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *Hero → Hero Preview → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Button Link field in *Hero → Hero Preview → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
  ...
  /**
   * Button Label field in *Hero → Hero Preview → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Image field in *Hero → Hero Preview → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
...
/**
 * Hero Preview variation for Hero Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
